<x-layouts.admin>
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600">Daftar booking terbaru.</p>
    </div>

    <div class="mt-6 rounded-lg bg-white p-4 ring-1 ring-black/5">
        <form method="GET" action="{{ route('admin.dashboard') }}" class="grid grid-cols-1 gap-3 sm:grid-cols-6">
            ...
            <div class="sm:col-span-6 flex items-center justify-end gap-2">
                <a href="{{ route('admin.dashboard') }}" class="rounded-md bg-gray-200 px-4 py-2 text-sm font-semibold text-gray-900 hover:bg-gray-300">Reset</a>
                ...
                @forelse ($bookings as $b)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="{{ route('admin.bookings.show', $b) }}" class="rounded-md bg-blue-700 px-3 py-2 text-xs font-semibold text-white hover:bg-blue-800">Detail</a>
                        </td>
                    </tr>
                @empty
                    <tr>
